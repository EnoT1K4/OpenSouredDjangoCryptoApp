...
DEFAULT_FROM_EMAIL = "Crypto App <mr.vladislav047@gmail.com>" # change this to your own email
...
SECRET_KEY = 'django-insecure-t9#=cbggyq5g1^k++^)5^&ggk70ng*g1=$t=8-*qmk#(lh@iv('
